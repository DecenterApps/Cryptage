        ...
        <div className="logo-wrapper" />
        {
          ...
          <div className="metamask-warning">
            <div className="metamask-warning-inner">
              ...
              <h3 onClick={() => { this.setState({ showExtendedWarning: !this.state.showExtendedWarning }); }}>
                What is MetaMask?
              </h3>
              {
                this.state.showExtendedWarning &&
                <p>
...
export default connect(mapStateToProps, mapDispatchToProps)(NicknameFormComp);
