...
const LargeCardMain = ({ id, image }) => (
  <svg width={226} height={313} viewBox="0 0 226 313" fill="none">
    ...
    <g filter={`url(#${id}lcfilter1_d)`}>
      <path d="M169.445 0H18.5134L0 18.6592V256.147V275.446H19.2154H169.445L188.66 256.147V19.2988V0H169.445Z" transform="translate(18.5601 18.7771)" stroke={`url(#${id}lcpaint3_linear)`} strokeOpacity="0.53" strokeWidth="1.77844" />
    </g>
    ...
    <path d="M3.86835 2.66561L0 0H48.3544L45.1308 2.66561H3.86835Z" transform="translate(89.0303 261.439) rotate(-0.21315)" fill="#9C01C2" />
    <defs>
      ...
      <linearGradient className="bottom-glow" id={`${id}lcpaint2_linear`} x2={1} gradientUnits="userSpaceOnUse" gradientTransform="matrix(1.77981 -95.9618 107.338 1.98469 49.5599 278.008)">
        <stop stopColor="#9B01C1" />
        <stop offset={1} stopColor="#9B01C1" stopOpacity={0} />
      </linearGradient>
      ...
      <linearGradient id={`${id}lcpaint4_linear`} x2={1} gradientUnits="userSpaceOnUse" gradientTransform="matrix(-188.66 0.0881314 60.0076 -11135.6 156.93 5567.53)">
        <stop stopColor="#9C01C2" stopOpacity={0} />
        <stop offset="0.221092" stopColor="#9C01C2" />
        <stop offset="0.768229" stopColor="#9C01C2" />
        <stop offset={1} stopColor="#9C01C2" stopOpacity={0} />
      </linearGradient>
